...
create index if not exists screening_tests_email_idx on screening_tests (candidate_email);
create index if not exists screening_tests_expires_idx on screening_tests (expires_at);
